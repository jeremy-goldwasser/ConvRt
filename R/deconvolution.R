...
#     specified DGP link; the convrt default.
#   link = "log": X = exp(B theta) on a cr regression spline with a uniform
#     2nd-derivative penalty (mgcv).  Alternative front-end for log-deconvolution
#     analyses (e.g. real-flu fits).
#
# X_hat depends only on the reporting delay pi_EY and severity rho; lambda by GCV.
...
# --- log-link, cr regression spline (alternative option; needs mgcv) ----------
