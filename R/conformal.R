...
# conformal.R
#
# Real-time split-conformal confidence-interval module for ConvRt.
#
# Recipe (split-conformal, absolute score, strictly real-time):
#
#   At a target vintage T, given a cache of daily ConvRt fits {R^{W'}}_{W' <= T}:
...
# dplyr / tibble are package dependencies (see DESCRIPTION: Depends).
