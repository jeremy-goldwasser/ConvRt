...
#
# convrt needs exactly two epidemiological inputs (besides the data):
...
# appears, and it produces a plain GI PMF -- the rest of convrt never sees the
# compartments.
...
# the convention of whichever ConvRt variant we're trying to reproduce.
#
