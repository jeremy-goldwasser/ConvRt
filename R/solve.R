# ConvRt :: solve.R
#
# gi_solve — penalised IRLS + KKT solver.  This is the standard ConvRt
...
gi_solve <- function(
  ...
  # Canonical defaults. The smoothing-spline ("pspline") penalty and the
  # unconstrained-mean fit are the only supported paths; the alternative
  # ridge-penalty and constrained-mean (QP) branches were removed.
  penalty      <- "pspline"
  constrain_mu <- FALSE
