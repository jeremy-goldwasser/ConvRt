...
#' @param fit     Fit list from solve_convrt (needs theta, mu, penalty, dow_effects).
...
# convrt's R_t IS the spline; no S(t)/N or 1/gamma rescaling.
gi_extract_rt <- function(
  ...
  # convrt's R_t IS the spline; no rescaling.
